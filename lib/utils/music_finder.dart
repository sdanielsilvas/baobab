...
class MusicFinder {
  ...
  Future<dynamic> seek(double seconds) => _channel.invokeMethod('seek', seconds);
...
//Finder
  ...
  MusicFinder setExecuteAfterPermissionGranted(bool executeAfterPermissionGranted) {
