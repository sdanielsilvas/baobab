...
class TimeLineName extends StatefulWidget {
  final String name;

  TimeLineName({this.name});

  @override
  _TimeLineName createState() {
    // TODO: implement createState
    return new _TimeLineName();
  }
}

class _TimeLineName extends State<TimeLineName> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(TimeLineName oldWidget) {
