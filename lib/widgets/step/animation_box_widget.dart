...
class AnimationBox extends StatelessWidget {
  AnimationBox({Key key, this.controller, this.screenWidth, this.onStartAnimation})
      : width = Tween<double>(
          begin: screenWidth,
          end: 40.0,
        ).animate(
            ...
            Opacity(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    'Activa tu cuenta.',
                    style: TextStyle(color: Color(0xFF2b7cb6), fontWeight: FontWeight.bold, fontSize: 30.0),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(top: 16.0, bottom: 120.0),
                    child: Text(
                      'Para activar tu cuenta necesitamos conocer mas acerca de ti.',
                      style: TextStyle(
                        fontSize: 16.0,
                      ),
                    ),
                ...
                child: Transform.scale(
                  ...
                  child: Container(
                    ...
                    child: GestureDetector(
                      child: Container(
                        height: height.value,
                        decoration: BoxDecoration(color: Color(0xFF2b7cb6), borderRadius: radius.value),
                        child: Center(
