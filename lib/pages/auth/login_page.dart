...
class _LoginPageState extends State<LoginPage> {
              ...
              Row(
                ...
                children: <Widget>[
                  FlatTextButton(
                    ...
                    onPressed: () => _onForgotPasswordButtonPressed(authBloc, context),
  ...
  _onLoginButtonPressed(AuthenticationBloc authBloc) {
    ...
    authBloc.onLogin(email: _loginEmailTextEditingController.text, password: _loginPasswordTextEditingController.text);
  ...
  _onForgotPasswordButtonPressed(AuthenticationBloc authBloc, BuildContext context) {
    showDialog(
        context: context,
